...
final class FeedCoordinator: BaseCoordinator, FeedCoordinatorProtocol {
    ...
    func presentNoStoryboardedVC() {
        let viewModel = NoStoryboardedViewModel(coordinator: self, vcTitle: "No Storyboarded")
        let controller = NoStoryboardedViewController(viewModel: viewModel)
