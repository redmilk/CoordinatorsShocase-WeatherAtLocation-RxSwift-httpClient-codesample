...
struct NavigationControllerFactory {
    ...
    static func makeStyled(style: Style,
        ...
        case .auth:
            return createStyledNavigation(rootVC: root, barTint: #colorLiteral(red: 0.8039215803, green: 0.8039215803, blue: 0.8039215803, alpha: 1), fontTint: .black, titleTint: .black)
        case .profile:
